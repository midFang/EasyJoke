...
public class ToolBar extends Toolbar {
    ...
    public ToolBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mLeftIcon = array.getResourceId(R.styleable.ToolBar_leftIcon, mLeftIcon);
        mLeftText = array.getString(R.styleable.ToolBar_leftText);
        mCenterText = array.getString(R.styleable.ToolBar_centerText);
        mRightIcon = array.getResourceId(R.styleable.ToolBar_rightIcon, mRightIcon);
        ...
        mCenterTextSize = array.getDimensionPixelSize(R.styleable.ToolBar_centerTextSize, dip2px(15));
        mLeftTextSize = array.getDimensionPixelSize(R.styleable.ToolBar_leftTextSize, dip2px(15));
        mRightTextSize = array.getDimensionPixelSize(R.styleable.ToolBar_rightTextSize, dip2px(15));
        mCenterTextColor = array.getColor(R.styleable.ToolBar_centerTextColor, Color.parseColor("#333333"));
        mLeftTextColor = array.getColor(R.styleable.ToolBar_leftTextColor, Color.parseColor("#333333"));
        mRightTextColor = array.getColor(R.styleable.ToolBar_rightTextColor, Color.parseColor("#333333"));
        mLeftIconMarginLeft = array.getDimensionPixelOffset(R.styleable.ToolBar_leftIconMarginLeft, 0);
        mRightIconMarginRight = array.getDimensionPixelOffset(R.styleable.ToolBar_rightIconMarginRight, 0);
        mLeftTextMarginLeft = array.getDimensionPixelOffset(R.styleable.ToolBar_leftTextMarginLeft, 0);
        mRightTextMarginRight = array.getDimensionPixelOffset(R.styleable.ToolBar_rightTextMarginRight, 0);
        mIsLeftTextFinishActivity = array.getBoolean(R.styleable.ToolBar_leftTextFinishActivity, false);

        mShowLeftIcon = array.getBoolean(R.styleable.ToolBar_showLeftIcon, mShowLeftIcon);
